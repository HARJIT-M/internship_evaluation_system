...
export default function CreateProject() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // const resp = await axios.post("http://localhost:8000/api/evaluation/add",
      //   { title, description },
      //   { headers: { Authorization: `Bearer ${token}` } })
      ...
      <div className="cp-left">
        ...
        <div className="cp-left-content">
          ...
          <p className="cp-left-description">
            Set up a new project, write a description, and assign interns
        ...
        <div className="cp-form-container">
          <div className="cp-card">
            <div className="cp-card-header">
              <h2 className="cp-card-title">New Project</h2>
              <p className="cp-card-subtitle">
                Fill in the details to create and assign a project
              </p>
            </div>
                  ...
                  {filteredInterns.map((intern) => (
                    ...
                    >
                      ...
                      <div className="cp-intern-info">
                        <span className="cp-intern-name">
                          {intern.name}
                        </span>
                        <span className="cp-intern-email">
                          {intern.email}
                        </span>
                      </div>
